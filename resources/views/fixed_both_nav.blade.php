...
<head>
    ...
    <title>ALAR TAXI | FIXED BOTH NAVBAR</title>
...
<body class="top_nav_fixed fixed_both">
...
<div id="header">
    ...
    <!-- BEGIN MENU BAR -->
    <div class="navbar navbar-default navbar-transparent navbar-fixed-top bordered" id="main_menu_bar">
        ...
        <div class="content-wrapper">
            <div class="page-header page-header-default">
                <div class="page-header-content">
                    <div class="page-title">
                        <h5><span class="f-w-700">Page Layouts</span> - FIXED BOTH NAVBAR</h5>

                        <ul class="breadcrumb">
                            <li><a href="index.html">Home</a></li>
                            <li><a href="javascript:void(0)">Page Layouts</a></li>
                            <li class="active">FIXED BOTH NAVBAR</li>
                        </ul>
                    </div>
            ...
            <div class="panel">
                <div class="panel-heading">
                    <h6 class="panel-title">FIXED BOTH NAVBAR</h6>
