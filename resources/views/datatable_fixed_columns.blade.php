...
@section('pageScript')
    ...
    <script src="{{ asset('assets/js/sm_tables_dataTable_Fixed_Columns.js') }}"></script>
@endsection
        ...
        <div class="col-md-12">
            <div class="panel">
                <div class="panel-heading">
                    <h6 class="panel-title">DataTables Fixed Columns</h6>
                ...
                <div class="panel-body">
                    <div class="sm-info">
                        <div class="sm-info-with-icon">
                            ...
                            <div class="sm-info-text">
                                <h5 class="sm-inner-header">Fixed Columns</h5>
                    ...
                    <table id="data-table" class="table table-striped table-bordered w-in-100">
                        <thead>
                        <tr>
