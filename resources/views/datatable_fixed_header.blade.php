...
@section('pageScript')
    ...
    <script src="{{ asset('assets/js/sm_tables_dataTable_Fixed_Header.js') }}"></script>
@endsection
        ...
        <div class="col-md-12">
            <div class="panel">
                <div class="panel-heading">
                    <h6 class="panel-title">DataTables Fixed Header</h6>
                    ...
                    <div class="sm-info">
                        <div class="sm-info-with-icon">
                            ...
                            <div class="sm-info-text">
                                <h5 class="sm-inner-header">Fixed Header</h5>
