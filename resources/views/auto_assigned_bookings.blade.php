...
@section('pageScript')
    ...
    <script src="{{ asset('assets/js/auto_assigned_bookings.js') }}"></script>
@endsection
...
@section('content')
        ...
        <div class="col-md-12">
            ...
            <div class="panel">
                <div class="panel-heading">
                    <h6 class="panel-title">Auto Assigned Bookings Search</h6>
    ...
    <div class="panel">
        <div class="panel-heading">
            <h6 class="panel-title">Auto Assigned Bookings</h6>
            <div class="heading-elements">
                <ul class="icons-list">
                    <li class="fullscreen_element"><a href="javascript:void(0)"></a></li>
                    <li class="collapse_element"><a class="up" href="javascript:void(0)"></a></li>
