...
<head>
    ...
    <title>ALAR TAXI | Sidebar Fixed Nav</title>
        ...
        <div class="content-wrapper">
            <div class="page-header page-header-default">
                <div class="page-header-content">
                    <div class="page-title">
                        <h5><span class="f-w-700">Page Layouts</span> - Sidebar Fixed Nav</h5>

                        <ul class="breadcrumb">
                            <li><a href="index.html">Home</a></li>
                            <li><a href="javascript:void(0)">Page Layouts</a></li>
                            <li class="active">Sidebar Fixed Nav</li>
                        </ul>
                    </div>
            ...
            <div class="panel">
                <div class="panel-heading">
                    <h6 class="panel-title">Sidebar Fixed Nav</h6>
