...
<head>
    ...
    <title>ALAR TAXI | Lock Screen</title>
...
<div class="form-body">
    <div class="row">
        <div class="img-holder right">
            <div class="bg" style="background-image: url('{{ asset('assets/images/svg/check.svg') }}');background-size: 80%;background-repeat: no-repeat;"></div>
                    ...
                    <div class="tabbable">
                        <div class="tab-content">
                            <div class="tab-pane active" id="bottom_style2">
                                <h3 class="f-w-400 m-b-5">Sign In!</h3>
                                <p class="m-b-0">Sign in to your account to continue</p>
                                <br>
                                <div class="form-group">
                                    <img src="{{ asset('assets/images/avatar/user-1.jpg') }}" class="thumbnail center_margin" alt="perfectin">
                                </div>
