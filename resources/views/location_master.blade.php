...
@section('pageScript')
    ...
    <script src="{{ asset('assets/js/location_master.js') }}"></script>
@endsection
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered w-in-100" id="table">
                            ...
                            <tr id="col_filter">
                                ...
                                <th class="apply_search">Location Name</th>
                                <th class="apply_search">Latitude</th>
                                <th class="apply_search">Longitude</th>
