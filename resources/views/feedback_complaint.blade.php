...
@section('pageScript')
    ...
    <script src="{{ asset('assets/js/feedback_complaint.js') }}"></script>
@endsection
...
@section('content')
        ...
        <div class="col-md-12">
            <div class="panel">
                <div class="panel-heading">
                    <h6 class="panel-title">Feedback / Complaint Search</h6>
    ...
    <div class="panel">
        <div class="panel-heading">
            <h6 class="panel-title">Feedback / Complaint</h6>
            <div class="heading-elements">
                <ul class="icons-list">
                    <li class="fullscreen_element"><a href="javascript:void(0)"></a></li>
                    <li class="collapse_element"><a class="up" href="javascript:void(0)"></a></li>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered w-in-100" id="table">
                            ...
                            <tr>
                                ...
                                <th class="apply_search">Feedback Type</th>
                                <th class="apply_search">Created Date</th>
                                <th class="apply_search">Feedback On</th>
