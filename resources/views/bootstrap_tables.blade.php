...
@section('pageScript')
    ...
    <script src="{{ asset('assets/plugins/bootstrap-table/extensions/export/bootstrap-table-export.js') }}"></script>
    <script src="{{ asset('assets/plugins/bootstrap-table/extensions/export/tableExport.js') }}"></script>
@endsection
        ...
        <div class="col-md-12">
            <div class="panel">
                <div class="panel-heading">
                    <h6 class="panel-title">Bootstrap Table</h6>
                ...
                <div class="panel-body">
                    <div class="sm-info">
                        <div class="sm-info-with-icon">
                            ...
                            <div class="sm-info-text">
                                <h5 class="sm-inner-header">Bootstrap Table</h5>
                    ...
                    <table data-toolbar="#toolbar"
                        ...
                        <thead>
                        <tr>
                            <th data-checkbox="true">checkbox</th>
                            <th data-checkbox="false">Rendering engine</th>
                            <th>Browser</th>
                            <th>Platform(s)</th>
