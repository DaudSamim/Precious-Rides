...
@section('pageScript')
    ...
    <script src="{{ asset('assets/js/add_customer_type_master.js') }}"></script>
@endsection

@section('content')
    <div class="panel">
        <div class="panel-heading">
            <h6 class="panel-title">Add Customer Type</h6>
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-12">
                    <form id="validate" action="/masters/customer_type_master" data-parsley-validate="true">
                        <div class="row">
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div id="cp2" class="input-group colorpicker-component"
                                        ...
                                        <input type="text" class="form-control" value="#4e54c8"/>
