...
<head>
    ...
    <title>ALAR TAXI | FIXED MENUBAR</title>
        ...
        <div class="content-wrapper">
            <div class="page-header page-header-default">
                <div class="page-header-content">
                    <div class="page-title">
                        <h5><span class="f-w-700">Page Layouts</span> - FIXED MENUBAR</h5>

                        <ul class="breadcrumb">
                            <li><a href="index.html">Home</a></li>
                            <li><a href="javascript:void(0)">Page Layouts</a></li>
                            <li class="active">FIXED MENUBAR</li>
                        </ul>
                    </div>
            ...
            <div class="panel">
                <div class="panel-heading">
                    <h6 class="panel-title">FIXED MENUBAR</h6>
