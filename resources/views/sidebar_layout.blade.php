...
<head>
    ...
    <title>ALAR TAXI | Sidebar Layout</title>
...
<!--Begin Sidebar-->
<div class="sidebar" data-color="black" data-image="{{ asset('assets/images/sidebar-bg.jpg') }}">
                            ...
                            <ul class="media-list dropdown-content-body w-in-20">
                                <li class="media">
                                    <div class="media-left">
                                        <img src="{{ asset('assets/images/avatar/user-1.jpg') }}" class="thumbnail"
                                             alt="perfectin">
                                    </div>
                                ...
                                <li class="media">
                                    <div class="media-left">
                                        <img src="{{ asset('assets/images/avatar/user-2.jpg') }}" class="thumbnail"
                                             alt="perfectin">
                                    </div>
                                ...
                                <li class="media">
                                    <div class="media-left">
                                        <img src="{{ asset('assets/images/pf_logo.png') }}" class="thumbnail"
                                             alt="perfectin">
                                    </div>
                                ...
                                <li class="media">
                                    <div class="media-left">
                                        <img src="{{ asset('assets/images/svg/server.svg') }}" class="thumbnail p-7"
                                             alt="perfectin">
                                    </div>
        ...
        <div class="content-wrapper">
            <div class="page-header page-header-default">
                <div class="page-header-content">
                    <div class="page-title">
                        <h5><span class="f-w-700">Page Layouts</span> - Sidebar Layout</h5>
            ...
            <div class="panel">
                <div class="panel-heading">
                    <h6 class="panel-title">Sidebar Layout</h6>
