...
@section('pageScript')
    ...
    <script src="{{ asset('assets/plugins/DataTables/extensions/AutoFill/js/autoFill.bootstrap.min.js') }}"></script>
    <script src="{{ asset('assets/plugins/DataTables/extensions/Responsive/js/dataTables.responsive.min.js') }}"></script>
    <script src="{{ asset('assets/js/sm_tables_dataTable_Autofill.js') }}"></script>
@endsection
        ...
        <div class="col-md-12">
            <div class="panel">
                <div class="panel-heading">
                    <h6 class="panel-title">DATATABLES AUTOFILL</h6>
                    ...
                    <div class="sm-info">
                        <div class="sm-info-with-icon">
                            ...
                            <div class="sm-info-text">
                                <h5 class="sm-inner-header">Autofill</h5>
