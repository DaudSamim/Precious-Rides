...
@section('pageScript')
    ...
    <script src="{{ asset('assets/js/customer_type_master.js') }}"></script>
@endsection

@section('content')
    <div class="panel">
        <div class="panel-heading">
            <h6 class="panel-title">Customer Type Master</h6>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered w-in-100" id="table">
                            ...
                            <tr id="col_filter">
                                ...
                                <th class="apply_select">Type</th>
                                <th class="apply_search">Color</th>
