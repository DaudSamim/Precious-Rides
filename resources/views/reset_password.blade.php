...
<div class="form-body">
    <div class="row">
        <div class="img-holder right">
            <div class="bg" style="background-image: url('{{ asset('assets/images/svg/get-started.svg') }}');background-size: 80%;background-repeat: no-repeat;"></div>
                    ...
                    <div class="tabbable">
                        <div class="tab-content">
                            <div class="tab-pane active" id="bottom_style2">
                                <h3 class="f-w-400 m-b-5">Reset Password!</h3>
                                ...
                                <div class="form-group m-b-20">
                                    <div class="form-group">
                                        <div class="sm-form-design">
                                            <input type="password" name="name" id="password1"
                                                   class="form-control"
                                ...
                                <div class="form-group m-b-20">
                                    <div class="form-group">
                                        <div class="sm-form-design">
                                            <input type="text" name="name" id="password2"
                                                   class="form-control"
