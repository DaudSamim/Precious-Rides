...
@section('pageScript')
    ...
    <script src="{{ asset('assets/js/make_payment.js') }}"></script>
@endsection
...
@section('content')
        ...
        <div class="col-lg-12">
            <div class="panel">
                <div class="panel-heading">
                    <h6 class="panel-title">Make Payment Search</h6>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select_2" multiple="multiple">
                                                ...
                                                <option value="51" selected="">455bb</option>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel">
                <div class="panel-heading">
                    <h6 class="panel-title">Make Payment Result</h6>
                    <div class="heading-elements">
                        <ul class="icons-list">
                            <li class="fullscreen_element"><a href="javascript:void(0)"></a></li>
                            <li class="collapse_element"><a class="up" href="javascript:void(0)"></a></li>
                        ...
                        <div class="col-lg-12">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered w-in-100" id="table">
                                    ...
                                    <tr>
                                        <td>1</td>
                                        <td>455bb - Indica AC</td>
                                        <td>0</td>
                                        <td>222.75</td>
                                        <td>222.75</td>
                                        <td>222.75</td>
                                        <td>0</td>
                                        <td><a href="javascript:void(0)" class="label label-success">Cash</a>
                                            <a href="javascript:void(0)" class="label label-danger m-t-5">Credit</a></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td></td>
                                        <td>0</td>
                                        <td>222.75</td>
                                        <td><input type="text" class="form-control input-sm w-in-100" value="222.75"></td>
                                        <td>0</td>
                                        <td></td>
                                        <td></td>
                                    </tr>
