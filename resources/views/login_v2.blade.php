...
<!-- BEGIN PAGE CONTENT -->
<div class="form-body transparent">
    <div class="row">
        <div class="form-holder left m-l-0">
            <div class="form-content">
                <div class="form-items boxed">
...
<!-- BEGIN PAGE LEVEL JS -->
<script src="{{ asset('assets/plugins/jquery-backstretch/jquery.backstretch.min.js') }}"></script>
