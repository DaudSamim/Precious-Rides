...
@section('pageScript')
    ...
    <script src="{{ asset('assets/js/vehicle_model_master.js') }}"></script>
@endsection
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered w-in-100" id="table">
                            ...
                            <tr id="col_filter">
                                ...
                                <th class="apply_select">Make</th>
                                <th class="apply_select">Tariff</th>
                                <th class="apply_select">Model</th>
                                <th class="apply_select">Seat</th>
                                <th class="apply_select">Mileage</th>
