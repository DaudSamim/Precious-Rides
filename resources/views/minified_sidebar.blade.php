...
<head>
    ...
    <title>ALAR TAXI | Minified Sidebar</title>
...
<body class="sidebar_menu top_nav_fixed sidebar-mini">
...
<!--Begin Sidebar-->
<div class="sidebar" data-color="blue" data-image="{{ asset('assets/images/sidebar-bg.jpg') }}">
        ...
        <div class="content-wrapper">
            <div class="page-header page-header-default">
                <div class="page-header-content">
                    <div class="page-title">
                        <h5><span class="f-w-700">Page Layouts</span> - Minified Sidebar</h5>

                        <ul class="breadcrumb">
                            <li><a href="index.html">Home</a></li>
                            <li><a href="javascript:void(0)">Page Layouts</a></li>
                            <li class="active">Minified Sidebar</li>
                        </ul>
                    </div>
            ...
            <div class="panel">
                <div class="panel-heading">
                    <h6 class="panel-title">Minified Sidebar</h6>
