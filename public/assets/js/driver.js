    ...
    execute: function () {
        ...
        table = $('#table').DataTable({
            ...
            "initComplete": function (settings, json) {
                ...
                $(settings.nTableWrapper).find('.row').first().find('#table_filter').append('<a href="add_owner" class="btn btn-dark btn-sm m-l-10"><i class="ion-plus"></i> Add Owner</a><a href="add_driver" class="btn btn-dark btn-sm m-l-10"><i class="ion-plus"></i> Add Driver</a>');
                var all_col = this;
