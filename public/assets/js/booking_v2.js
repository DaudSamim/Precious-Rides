...
var app = {
    ...
    execute: function () {
        ...
        var allMarkers = [];
        var styles = [[{
            url: image_path+'images/culster.png',
            height: 98,
            width: 106,
            anchor: [35, 37],
            textColor: '#ff00ff',
        ...
        function CenterControl(controlDiv, map) {
            ...
            var imgpath = image_path + 'images/current_location.png';
            controlText.innerHTML = '<img id="center_img_loc" src="'+imgpath+'" style="width: 60%;" />';
